...
# Delete tables content before running the script
...
do
  ...
  then
    ...
    # Insert teams into teams tables
    ...
    # Insert row data into games table
    ...
    then
      echo "Inserted game: $WINNER $WINNER_GOALS X $OPPONENT_GOALS $OPPONENT"
    fi
  fi
done